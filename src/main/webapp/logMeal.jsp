...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .food-grid::-webkit-scrollbar-track { background: transparent; }
...
<%
    ...
    // Build flat JSON of all foods for JS
...
<div class="main">
    ...
    <% } %>
    <% if (success != null) { %>
        <div class="alert-success">✅ Meal logged successfully!</div>
    <% } %>
    ...
    <!-- Serving Section (shown after food selected) -->
    <div class="serving-section" id="servingSection">
        ...
        <div class="serving-controls">
            ...
            <div class="serving-input-wrap">
                ...
                <input type="number" id="servingsInput" class="serving-input"
        ...
        <form action="logMeal" method="post" id="logMealForm">
            ...
            <button type="submit" class="btn-submit" id="submitBtn" onclick="prepareSubmit()">
                Log Meal →
            </button>
        </form>
    </div>
...
<script>
    ...
    function selectFood(card) {
        ...
        document.getElementById('selectedServingInfo').textContent =
            'Per serving: ' + selectedFoodData.servingDesc + ' • ' +
            selectedFoodData.calsPerServing + ' kcal';

        document.getElementById('servingsInput').value = 1;
        document.getElementById('servingSection').classList.add('visible');

        // Scroll to serving section smoothly
    ...
    function setServings(val) {
        document.getElementById('servingsInput').value = val;
        updatePreview();
    }
    ...
    function changeServings(delta) {
        ...
        if (val < 0.5) val = 0.5;
        if (val > 20) val = 20;
        input.value = Math.round(val * 2) / 2; // snap to 0.5
        updatePreview();
    }
    ...
    function updatePreview() {
        ...
        const cals = (selectedFoodData.caloriesPer100g * grams) / 100;
        ...
        document.getElementById('previewCals').textContent = Math.round(cals);
        document.getElementById('previewProtein').textContent = protein.toFixed(1) + 'g';
        document.getElementById('previewCarbs').textContent = carbs.toFixed(1) + 'g';
        document.getElementById('previewFat').textContent = fat.toFixed(1) + 'g';
    }
