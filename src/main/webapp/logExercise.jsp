    ...
    <form action="logExercise" method="post" id="exerciseForm">
        ...
        <div class="section-card">
            ...
            <div class="intensity-row">
                <div class="intensity-btn" onclick="selectIntensity('Light', this)">
                    <div class="intensity-label">🌿 Light</div>
                    <div class="intensity-desc">Easy, can talk freely</div>
                </div>
                <div class="intensity-btn active-moderate" onclick="selectIntensity('Moderate', this)">
                    <div class="intensity-label">⚡ Moderate</div>
                    <div class="intensity-desc">Steady, some effort</div>
                </div>
                <div class="intensity-btn" onclick="selectIntensity('Intense', this)">
                    <div class="intensity-label">🔥 Intense</div>
                    <div class="intensity-desc">Hard, max effort</div>
                </div>
            </div>
        </div>
        ...
        <div class="section-card">
            ...
            <div class="duration-row">
                ...
                <input type="number" id="durationInput" name="duration" class="duration-input"
                       value="30" min="1" max="600" oninput="updatePreview()">
                <button type="button" class="dur-btn" onclick="changeDuration(5)">+</button>
            </div>
        </div>
...
<script>
    ...
    function selectIntensity(level, el) {
        document.querySelectorAll('.intensity-btn').forEach(b =>
            b.classList.remove('active-light', 'active-moderate', 'active-intense'));
    ...
    function validateForm() {
        if (!document.getElementById('activityInput').value) {
            alert('Please select an activity!'); return false;
        }
        const dur = document.getElementById('durationInput').value;
        if (!dur || dur < 1) {
            alert('Please enter a valid duration!'); return false;
        }
        return true;
    }
</script>
